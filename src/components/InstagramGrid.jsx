      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 max-w-xl mx-auto">
            Acompanhe em tempo real as novidades do mercado de luxo e os bastidores das propriedades mais exclusivas do país.
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <button className="inline-flex items-center gap-2 px-8 py-4 bg-white border border-gray-200 rounded-full font-medium hover:bg-gray-50 transition-all shadow-sm">
