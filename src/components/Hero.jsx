...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-between px-6 lg:px-24 py-20 overflow-hidden">
      <div className="z-10 max-w-2xl">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-10 font-light leading-relaxed">
            Curadoria especializada em imóveis de alto padrão que transcendem o conceito de morar. Descubra sua próxima obra-prima.
          </p>
      ...
      <div className="hidden lg:block relative w-1/2 h-[600px]">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-4 px-2">
            ...
            <span className="text-xs font-semibold">exclusive_realty</span>
          </div>
          ...
          <div className="px-2">
            ...
            <p className="text-[10px] leading-tight">
              <span className="font-bold">exclusive_realty</span> Vista definitiva para o skyline da cidade. O novo padrão de luxo acaba de ser redefinido... #luxuryliving
            </p>
          </div>
        </motion.div>
